...
export default function Privacy() {
  ...
  return (
    <main>
      ...
      <section className="pt-[calc(var(--navbar-height)+4rem)] pb-16">
        <div className="w-full grid grid-cols-12 items-center px-2.5 md:px-[15px]">
          <div className="col-span-12 md:col-start-7 md:col-span-3">
            ...
            <div className="space-y-8">
              ...
              <div className="pt-8">
                <p className="text-p opacity-60 mb-2">Last updated: April 8, 2024</p>
                <Link 
                  href="/" 
